...
#%%
hyp_filename = '/Users/verjim/laptop_D_17.01.2022/Schmitz_lab/data/mouse/2021.11.09/21n09013.abf'
dep_filename = '/Users/verjim/laptop_D_17.01.2022/Schmitz_lab/data/mouse/2021.11.09/21n09012.abf'
...
def load_traces(hyp_filename, dep_filename, cell_chan):
    ...
    block_h = hyp_r.read(signal_group_mode = 'split-all')[0]
    hyp_sweeps = len(block_h.segments)
    dep_r = neo.io.AxonIO(filename=dep_filename)
    block_d = dep_r.read(signal_group_mode = 'split-all')[0]
