...
#%%
# collect all data. 0 hrs incubation
hrs_inc_ = 16
...
adult_df_complete = adult_df_complete[adult_df_complete['area'] == 'temporal']

# adult_df_complete = adult_df_complete[adult_df_complete.area == 'temporal']
# adult_df_complete.to_excel('/Users/verjim/laptop_D_17.01.2022/Schmitz_lab/results/human/' + \
#                            'paper_figs_collected_checked/data/adult_16min_hrs_inc_temporal.xlsx')
...
# get data separated by hrs_incubation
