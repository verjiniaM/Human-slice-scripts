...
def analyse_testing_high_K_condition(OP, patcher, human_dir = '/Users/verjim/laptop_D_17.01.2022/Schmitz_lab/data/human/'): 
    ...
    ## Create dataframe with inoput and series resistance from VC and VC_end files (QC)
    ...
    ## Create dataframe with intrinsic properties from freq_analyse files
    ...
    #Create df with resting membrane potentials at different timepoints
    # Multiple RMP are collected from files with longer recording times
...
#%%
def main():
     analyse_testing_high_K_condition(OP, patcher)
